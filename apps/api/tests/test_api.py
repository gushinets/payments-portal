...
from app.domains.identity.services.checkout import CheckoutCommand, create_checkout  # noqa: E402
    ...
    *,
    ...
    with SessionLocal() as db:
        ...
        result = create_checkout(
            db,
            user=user,
            providers=cloudpayments_app.state.payment_provider_registry,
            command=CheckoutCommand(
                plan_id=plan.id,
                auto_renew=False,
                recurring_consent_acceptance_id=None,
                entrypoint_type="product",
                entrypoint_value=product,
                frontend_id="retained_test",
                source_url=None,
                client_ip=None,
                user_agent=None,
            ),
