...
EXPECTED_COLUMNS = {
    ...
    "country_region_rules": {
        "id", "country_code", "region", "market_enabled", "strict_mismatch", "default_document_set"
    },
    "users": {
        "id", "tenant_id", "region", "email", "email_normalized", "email_verified_at", "status",
        "last_login_at", "password_hash", "metadata", "created_at", "updated_at",
    },
    "auth_sessions": {
        "id", "tenant_id", "region", "user_id", "token_hash", "created_at", "expires_at",
        "last_seen_at", "revoked_at", "ip", "user_agent",
    },
    "magic_link_tokens": {
        "id", "tenant_id", "region", "user_id", "email_normalized", "token_hash", "purpose",
        "created_at", "expires_at", "used_at", "ip", "user_agent",
    },
    "password_reset_rate_limits": {
        "rate_limit_key", "count", "window_start", "expires_at", "created_at", "updated_at"
    },
    "legal_entities": {
        "id", "tenant_id", "region", "name", "entity_type", "tax_id", "registration_id",
        "legal_address", "support_email", "status", "created_at", "updated_at",
    },
    "document_versions": {
        "id", "tenant_id", "region", "legal_entity_id", "doc_type", "version", "title", "url_path",
        "content_hash", "published_at", "effective_from", "is_active", "requires_acceptance",
        "created_at", "updated_at",
    },
    "legal_acceptance_events": {
        "id", "tenant_id", "region", "user_id", "external_billing_account_id", "billing_offer_id",
        "accepted_commercial_fingerprint", "accepted_at", "ip", "user_agent", "created_at",
    },
    "document_acceptances": {
        "id", "legal_acceptance_event_id", "tenant_id", "region", "user_id", "document_version_id",
        "acceptance_kind", "acceptance_text_hash", "created_at",
    },
    "capability_manifest_projections": {
        "projection_id", "tenant_id", "region", "schema_version", "manifest_version", "generated_at",
        "last_complete_sync_at", "manifest_document",
    },
    "external_billing_catalog_projections": {
        "projection_id", "external_billing_account_id", "schema_version", "catalog_version",
        "catalog_digest", "last_complete_sync_at", "catalog_document",
    },
    "commercial_mapping_revisions": {
        "mapping_revision_id", "external_billing_account_id", "billing_offer_id", "revision_number",
        "manifest_version", "catalog_version", "catalog_digest", "mapping_schema_version",
        "mapping_document", "published_at", "published_by_principal",
    },
    "external_billing_customers": {
        "customer_id", "external_billing_account_id", "user_id", "billing_customer_key",
        "provider_customer_id", "binding_state", "binding_updated_at", "created_at",
    },
    "purchase_intents": {
        ...
        "legal_acceptance_event_id", "created_at", "state_updated_at", "resolved_at",
    },
    "external_create_operations": {
        "create_operation_id", "operation_kind", "customer_id", "purchase_intent_id",
        "request_correlation_key", "operation_state", "unknown_since", "unknown_recovery_deadline_at",
        "recovery_hint_schema_version", "recovery_hint_document", "bound_external_object_id",
        "created_at", "updated_at", "resolved_at",
    },
    "billing_product_access_scopes": {
        "access_scope_id", "user_id", "product_id", "primary_subscription_id", "updated_at"
    },
    "external_subscriptions": {
        "subscription_id", "external_billing_account_id", "customer_id", "user_id", "product_id",
        "purchase_intent_id", "mapping_revision_id", "external_subscription_id", "external_agreement_id",
        "lifecycle_status", "financial_access_status", "commercial_access_status",
        "last_authoritative_read_at", "projection_valid_until", "reconciliation_lease_owner",
        "reconciliation_lease_expires_at", "reconciliation_fencing_token", "latest_observation_id",
        "created_at", "updated_at",
    },
    "billing_state_observations": {
        "observation_id", "observation_kind", "external_billing_account_id", "user_id", "product_id",
        "access_scope_id", "subscription_id", "purchase_intent_id", "work_item_id",
        "basis_observation_id", "observed_at", "effective_at", "evidence_schema_version",
        "evidence_document", "completeness_classification", "result_classification",
        "resulting_access_revision", "created_at",
    },
    "purchased_allowances": {
        "allowance_id", "subscription_id", "source_component_id", "product_id", "metric_key", "quantity",
        "provider_cycle_key", "provider_cycle_start", "provider_cycle_end", "period_start", "period_end",
        "created_at",
    },
    "external_billing_webhook_deliveries": {
        "delivery_id", "external_billing_account_id", "provider_event_id", "payload_hash",
        "correlation_schema_version", "correlation_document", "evidence_schema_version",
        "evidence_document", "processing_state", "received_at", "processing_started_at", "processed_at",
        "last_error_classification",
    },
    "billing_work_items": {
        "work_item_id", "work_kind", "scope_kind", "scope_reference", "coalescing_key",
        "payload_schema_version", "payload_document", "priority", "next_attempt_at", "attempt_count",
        "work_state", "lease_owner", "lease_expires_at", "last_error_classification", "created_at",
        "updated_at",
    },
    "manual_review_cases": {
        "review_case_id", "reason_code", "scope_kind", "scope_reference", "evidence_schema_version",
        "evidence_document", "case_state", "created_at", "resolved_at", "resolved_by_principal",
        "resolution_schema_version", "resolution_document",
    },
    "paid_access_states": {
        "paid_access_state_id", "tenant_id", "region", "user_id", "access_revision",
        "effective_state_schema_version", "effective_state_document", "committed_at",
    },
    "access_invalidation_outbox": {
        "outbox_id", "tenant_id", "region", "user_id", "pending_revision", "delivered_revision",
        "attempt_count", "next_attempt_at", "last_error_classification", "created_at", "updated_at",
    },
}
...
EXPECTED_CHECKS = {
    ...
    "external_billing_customers": {
        "ck_external_billing_customers_key_nonempty", "ck_external_billing_customers_binding_state"
    },
    "purchase_intents": {
        "ck_purchase_intents_fingerprint_nonempty", "ck_purchase_intents_idempotency_nonempty",
        "ck_purchase_intents_snapshot_schema_nonempty", "ck_purchase_intents_state",
    },
    "external_create_operations": {
        "ck_external_create_operations_purchase_requirement", "ck_external_create_operations_kind",
        "ck_external_create_operations_correlation_nonempty", "ck_external_create_operations_unknown_pair",
        "ck_external_create_operations_unknown_deadline", "ck_external_create_operations_recovery_hint_pair",
    },
    "billing_product_access_scopes": set(),
    "external_subscriptions": {
        "ck_external_subscriptions_purchase_mapping", "ck_external_subscriptions_lifecycle_status",
        "ck_external_subscriptions_financial_access_status", "ck_external_subscriptions_commercial_access_status",
    ...
    "billing_state_observations": {
        ...
        "ck_billing_state_observations_subject_shape", "ck_billing_state_observations_kind",
        "ck_billing_state_observations_kind_shape", "ck_billing_state_observations_evidence_schema_nonempty",
    },
    "purchased_allowances": {
        "ck_purchased_allowances_quantity_nonnegative", "ck_purchased_allowances_provider_cycle_pair",
