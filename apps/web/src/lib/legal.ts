...
export const legalDocuments: Record<LegalSlug, LegalDocumentMeta> = {
  privacy: {
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/01-privacy-policy.md"
  },
  "consent-personal-data": {
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/02-consent-personal-data.md"
  },
  offer: {
    slug: "offer",
    href: "/ru/offer",
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/03-offer.md"
  },
  cancellation: {
    slug: "cancellation",
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/04-cancellation-refund.md"
  },
  cookies: {
    slug: "cookies",
    href: "/ru/cookies",
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/05-cookie-policy.md"
  },
  security: {
    slug: "security",
    href: "/ru/security",
    ...
    version: "2026-07-02",
    sourcePath: "2026-07-02/06-security-policy.md"
  }
};
